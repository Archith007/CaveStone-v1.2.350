...
function setup() {
  ...
  border1 = createSprite(400*main,0*main,800*main,5*main)
  border1.shapeColor = "#000000"

  border2 = createSprite(400*main,800*main,800*main,5*main)
  border2.shapeColor = "#000000"

  border3 = createSprite(800*main,400*main,5*main,800*main)
  border3.shapeColor = "#000000"

  border4 = createSprite(0*main,400*main,5*main,800*main)
